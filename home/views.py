...
def makeappointment(request):
    if request.method=='POST':
        if 'submit' in request.POST:
            ...
            p_obj=Patient_object(pat_name,pat_age,pat_emailid,patgen,doctor_ass,pat_num) 
            if p_obj.p_doc=='csp' :
                fr=open(r'D:\c++ course\python\clinic\appointment\appointmentcsp.csv','r') 
                reader=csv.reader(fr) 
                reader=list(reader)
                if len(reader)<3:

                
                    fw=open(r'D:\c++ course\python\clinic\appointment\appointmentcsp.csv','a',newline="") 
                ...
                fr=open(r'D:\c++ course\python\clinic\appointment\appointmentgendoc.csv','r') 
                reader=csv.reader(fr) 
                reader=list(reader)
                if len(reader)<3:

                
                    fw=open(r'D:\c++ course\python\clinic\appointment\appointmentgendoc.csv','a',newline="") 
                    data=[pat_name,pat_age,pat_emailid,patgen,doctor_ass,pat_num]
                    writer=csv.writer(fw)
                    writer.writerow(data)
                    fw.close()
    ...
    if request.method=='POST':
        ...
        if 'submit' in request.POST:
            ...
            if doctor_ass=='csp':
                ...
                f=open(r'D:\c++ course\python\clinic\appointment\appointmentgendoc.csv','r',newline="") 
                reader=csv.reader(f) 
                reader=list(reader)
                try:
                    for row in reader:
